ConvenientListView : View {
	...
	classvar winW = 250, winH = 200;
	classvar dragSourceHeight = 22;
	classvar fontSize = 15;
	classvar boldList = false;
	...
	*open {
		var backgroundColor = Color.fromHexString("#00e277");
    ...
    *makeList {
        ...
        Convenience.bufferKeys.do{ | key |
				...
				.font_(Font(fontName, fontSize, bold: boldList))
